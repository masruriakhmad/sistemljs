...
class MPenerimaan_grey extends CI_Model{
	...
	//controller Penerimaan_grey/laporan
	function getAll(){
			...
			$this->db->select('*');
		 	...
		 	$this->db->join('grey_tb','grey_tb.kd_kain				=terimagrey_tb.kd_kain','left');
	
		 	$this->db->join('mesin_tb','mesin_tb.kd_mesin			=terimagrey_tb.kd_mesin','left');
	
		 	$this->db->join('gudang_tb','gudang_tb.kd_gudang		=terimagrey_tb.kd_gudang','left');
	
		 	$this->db->join('customer_tb','customer_tb.kd_customer	=terimagrey_tb.kd_customer','left');
	
		 	$this->db->join('user_tb','user_tb.kd_user				=terimagrey_tb.kd_user','left');
	...
	//untuk tampilan laporan
	//controller Penerimaan_grey/filter laporan
	...
	function readPenerimaan_grey($key){
	...
	function insertPenerimaan_grey($data){
			
			$query = $this->db->insert_batch('terimagrey_tb',$data);
	...
	function batalPenerimaan_grey($no_tr_grey,$table,$data){
		...
		//fungsi untuk batal penerimaan
	function updatePenerimaan_grey($no_tr_grey,$table,$data){
	...
	function deletePenerimaan_grey($no_tr_grey){
