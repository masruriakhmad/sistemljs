                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-body">
                      ...
                      <thead style = "background-color :  #d6eaf8">
                        <tr>                       
                          <th class="col-sm-1">No.Penggunaan</th>
                          <th class="col-sm-2">Tanggal</th>
                          <th class="col-sm-1">Jenis jarum</th>
                          <th class="col-sm-1">Ukuran jarum</th>
                          <th class="col-sm-1">Jumlah</th>
                          <th class="col-sm-1">Nomer Mesin</th>
                      ...
                      <?php
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            <td><?php echo $row->no_tr_pakaijarum; ?></td>
