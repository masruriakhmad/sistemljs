...
<head>
  ...
  <title>Laporan Pengiriman Kain Jadi</title>
               ...
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12 ">
                        ...
                        <h3>
                          Tabel  <span class="fa-angle-right fa"></span> Laporan Pengiriman Kain Jadi
                        </h3>
                ...
                <div class="col-md-12 col-sm-12">
                  ...
                  <!-- <div class="row"><div class="col-md-12 col-sm-12" id="responsive"></div></div>-->
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Laporan Pengiriman Kain Jadi</h3></div>
                    <div class="panel-body" align="center">
                    <form action="<?php echo base_url('Pengiriman_kainjadi/laporanFilter'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                      <div class="col-md-12">
                          ...
                          <a href="<?php echo base_url('Pengiriman_kainjadi/reset'); ?>">
                     ...
                     <table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">
                      <thead style = "background-color :  #d6eaf8">
                        <tr>
                          ...
                          <th class="col-sm-1">Nama Customer</th>
