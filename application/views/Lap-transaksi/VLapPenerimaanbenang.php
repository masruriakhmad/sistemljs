...
<head>
  ...
  <title>Laporan Penerimaan Benang</title>
                ...
                <div class="col-md-12 col-sm-12">
                  ...
                  <!-- <div class="row"><div class="col-md-12 col-sm-12" id="responsive"></div></div>-->
                   <!-- responsiv delete -->
                    ...
                    <form action="<?php echo base_url('Penerimaan_benang/laporanFilter'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                      <div class="col-md-12">
                          ...
                          <a href="<?php echo base_url('Penerimaan_benang/reset'); ?>">
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            ...
                            <td><?php echo number_format($row->jumlah*181.44,2); ?></td>
