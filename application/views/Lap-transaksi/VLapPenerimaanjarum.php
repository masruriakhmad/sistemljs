...
<head>
  ...
  <title>Laporan Penerimaan Jarum</title>
               ...
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12 ">
                        ...
                        <h3>
                          Tabel  <span class="fa-angle-right fa"></span> Laporan Penerimaan Benang
                        </h3>
                ...
                <div class="col-md-12 col-sm-12">
                  ...
                  <!-- <div class="row"><div class="col-md-12 col-sm-12" id="responsive"></div></div>-->
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Laporan Penerimaan Benang</h3></div>
                    <div class="panel-body" align="center">
                    <form action="<?php echo base_url('Penerimaan_jarum/laporanFilter'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                      <div class="col-md-12">
                          ...
                          <a href="<?php echo base_url('Penerimaan_jarum/reset'); ?>">
                    ...
                    <div class="panel-body">
                      ...
                      <thead style = "background-color :  #d6eaf8">
                        <tr>                       
                          ...
                          <th class="col-sm-2">Jenis jarum</th>
                      ...
                      <?php
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            <td><?php echo $row->no_tr_jarum; ?></td>
                            ...
                            <td><?php echo $row->nm_user; ?></td>
                              <!-- <td>
                            <a href="<?php //echo base_url('Penerimaan_jarum/cetakProses/'.$row->no_tr_jarum.''); ?>" data-confirm="Cetak Penerimaan ini?" data-toogle="tooltip" title="cetak transaksi">
                            ...
                            <a href="<?php //echo base_url('Penerimaan_jarum/batalProses/'.$row->no_tr_jarum.''); ?>" data-confirm="Batalkan Penenerimaan ini?" data-toogle="tooltip" title="Hapus transaksi">
