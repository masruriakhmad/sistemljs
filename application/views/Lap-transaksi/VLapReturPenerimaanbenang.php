...
<head>
  ...
  <title>Laporan Retur Benang</title>
               ...
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12 ">
                        ...
                        <h3>
                          Tabel  <span class="fa-angle-right fa"></span> Laporan Retur Benang
                        </h3>
                ...
                <div class="col-md-12 col-sm-12">
                  ...
                  <!-- <div class="row"><div class="col-md-12 col-sm-12" id="responsive"></div></div>-->
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Laporan Retur Benang</h3></div>
                    <div class="panel-body" align="center">
                    <form action="<?php echo base_url('Retur_benang/laporanFilter'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                      <div class="col-md-12">
                          ...
                          <a href="<?php echo base_url('Retur_benang/reset'); ?>">
