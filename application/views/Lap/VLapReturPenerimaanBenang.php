...
<body id="" class="dashboard" >
 ...
 <b font-size="11">CV. Langgeng Jaya Santoso</b><br>
                      ...
                      <hr>
                      <p align="center" font-size="14"> <b>SURAT JALAN RETUR BENANG</b></p>
                    </p>
                  ...
                  <div class="col-md-12">
                     <table>
                        ...
                        <td>No. Penerimaan</td>
                        <td>:</td>
                        <td><b><?php echo $result->no_retur_benang; ?></b></td>
                        <td width="100px">  </td>
                        <td>Vendor Tujuan</td>
                        <td>:</td>
                        ...
                        <tr>
                          ...
                          <th width="100px">Kg</th>
                           ...
                           <tr height="50px">
                            ...
                            <td><br>
                              <?php echo number_format($result->jumlah/181.44,2) 


                              ?>  <br><br>
                              </td>
                             <td><br><?php echo number_format($result->jumlah,2); ?><br><br></td>
                          </tr>
                        <tr>
                            <td><b>Total</b></td> 
                            <td><b><?php echo number_format($result->jumlah/181.44,2); ?></b></td>
                            <td><b><?php echo number_format($result->jumlah,2) ?></b></td>  
                          </tr>
                        </table>
