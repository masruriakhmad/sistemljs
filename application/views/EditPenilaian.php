...
<head>
  ...
  <title>Form Penilaian Tim</title>
            ...
            <div class="tabs-wrapper">             
                ...
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Penilaian/update/'.$edit['id_kriteria'].'') ?>" autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Penilaian Tim
                        </h3>
                    </div>
                  <div class="col-md-10">
                      ...
                      <div class="col-md-12">
                        <form class="cmxform" id="signupForm" method="get" action="">
                          <div class="col-md-6">
                            ...
                            <h4><?php echo $edit['id_kriteria']; ?></h4>


                           <div class="form-group">
                            <label>Skor</label>
                                  <select class="form-control" name="skor" value="<?php echo $edit['skor']; ?>" required>
                                    <option>1</option>
                                    <option>2</option>
                                    <option>4</option>
                                    <option>5</option>
