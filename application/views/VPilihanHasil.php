...
<body id="mimin" class="dashboard" onload="setInterval('displayServerTime()', 1000);">
      ...
      <?php $this->load->view('menu'); ?>
                    ...
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                           <div class="box-body no-padding">
                              ...
                              <h3 class="box-title" style = "color : <?php echo $this->session->userdata("color");?>"> <i class = "fa fa-user"></i> &nbsp; Pilih Data Hasil</h3>
                          </div>
                        </h3>
                    </div>
                  </div>
        ...
        <?php 
          ...
          if ($pesan){ ?>
            <div class="alert alert-<?php echo $this->session->flashdata('alert');?> alert-dismissible">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
              <h4><i class="icon fa fa-ban"></i> <?php echo $this->session->flashdata('judul');?> </h4>
              <?php echo $pesan;?>
            </div>
          <?php } ?>
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <?php } ?>
                    <form class="form-horizontal" action = "<?php echo site_url("Komputasi/dataHasil")?>" method = "GET">
              <div class="box-body">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-small btn-success btn-flat pull-right">Tampilkan</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
