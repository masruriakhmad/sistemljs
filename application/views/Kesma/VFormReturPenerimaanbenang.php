...
<head>
  ...
  <title>Form Retur Penerimaan Benang</title>
    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Retur_benang/createProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Data Retur Penerimaan Benang
                        </h3>
                    </div>
                  <div class="col-md-12">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Tambah Data Retur Penerimaan Benang</h4>
                    </div>
                      ...
                      <div class="col-md-12">
                         <form class="form-horizontal">                           
                              <div class="form-group">
                                <div class="col-sm-5">
                                  <label class="control-label">Nama Benang</label><br>
                                  <select class="selectpicker" data-live-search="true" name="kd_benang" id="kd_benang" required>
                                    <option value="">--Pilih--</option>
                                  <?php
                                  foreach ($benang->result() as $row) {
                                    echo "<option value='".$row->kd_benang."'>".$row->jenis_benang." | | ".$row->nm_vendor." | | ". number_format($row->stock,3)." Kg </option>";
                                  }    
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  ...
                                  foreach ($vendor->result() as $row) {
                                    echo "<option value='".$row->kd_vendor."'>".$row->nm_vendor."</option>";
                                  }    
                                ?>
                                <?php
                                 echo "</select>"; ?>
                              ...
                              <div class="form-group">
                                <div class="col-sm-6">
                                  ...
                                  <input class="form-control" id="jumlah" type="text" name="jumlah" placeholder="Diisi" onkeypress="return isNumberKey(event)" required>
                                </div>
                              </div>
                              <br/><br/> 
                              <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-10">
                                  ...
                                  <textarea class="form-control" id="ket" type="text" name="ket" placeholder="Diisi " required></textarea>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                            <div class="col-md-12">
