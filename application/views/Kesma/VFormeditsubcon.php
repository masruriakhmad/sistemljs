...
<head>
  ...
  <title>Form Edit Master Subcon</title>
    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Subcon/update'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Edit Master Subcon
                        </h3>
                    </div>
                  <div class="col-md-10">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Edit Data Master Subcon</h4>
                    </div>
                         ...
                         <form class="form-horizontal">                           
                          <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="kd_subcon" type="text" name="kd_subcon" placeholder="Diisi "value="<?php echo $edit['kd_subcon']; ?>"/readOnly>
                                </div>
                              </div>
                              <br/><br/> <br/><br/> 
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="nm_subcon" type="text" name="nm_subcon" placeholder="Diisi " value="<?php echo $edit['nm_subcon']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
