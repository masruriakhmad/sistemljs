                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Grey
                        </h3>
                    </div>
                  </div>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Data Master Grey</h3></div>
                    <div class="panel-body">
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            ...
                            <td>
                            <a href="<?php echo base_url('Grey/edit/'.$row->kd_kain.''); ?>" data-toogle="tooltip" title="Edit">
                              <button class=" btn btn-circle btn-mn btn-primary" value="primary">
                                <span class="fa fa-edit"></span>
                              </button>
                            </a>
                             <a href="<?php echo base_url('Grey/delete/'.$row->kd_kain.''); ?>" data-confirm="anda yakin ingin menghapus?" data-toogle="tooltip" title="Hapus transaksi">
