...
<head>
  ...
  <title>Edit Detail Penerimaan Kain Jadi</title>
               ...
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12 ">
                        ...
                        <h3>
                          Tabel  <span class="fa-angle-right fa"></span> Edit Detail Penerimaan Kain Jadi
                        </h3>
                ...
                <div class="col-md-12 col-sm-12">
                  ...
                  <!-- <div class="row"><div class="col-md-12 col-sm-12" id="responsive"></div></div>-->
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3> Edit Detail Penerimaan Kain</h3></div>
                    <div class="panel-body">
                      <div class="table-responsive" >
                        <form action="<?php echo base_url('Penerimaan_kainjadi/editPerNoPartaiProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                      ...
                      <thead style = "background-color :  #d6eaf8">
                        <tr>
                          ...
                          <th >Edit</th>
                           ...
                           <tr>
                            <td>
                              <?php echo $result->no_partai; ?>
                              <input type="hidden" name="no_tr_kainjadi" value="<?php echo $result->no_tr_kainjadi; ?>" required>
                              <input type="hidden" name="no_partai" value="<?php echo $result->no_partai; ?>" required>
                            </td>
                            <td>
                              <?php echo $result->nm_kain; ?>
                            </td>
                            <td>
                              <input type="text" name="setting" value="<?php echo $result->setting; ?>" required>
                            </td>
                            <td>
