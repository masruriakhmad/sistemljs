...
<head>
  ...
  <title>Form Top Up Produksi</title>
    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-20">
                    <form action="<?php echo base_url('Produksi/topUpProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Top Up Produksi
                        </h3>
                    </div>
                  <div class="col-md-20">
                  <div class="col-md-20 panel">
                    <div class="col-md-20 panel-heading">
                      <h4>Tambah Benang Ke Mesin</h4>
                    </div>
                         ...
                         <form class="form-horizontal">
                              ...
                              <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input type="hidden" id="no_produksi" name="no_produksi" value="<?php echo $produksi->no_produksi?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input class="form-control" id="kg" type="text" name="kg" placeholder="Diisi Kg Per Cones" required>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
