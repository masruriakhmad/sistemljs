...
<head>
  ...
  <title>Data Edit List Partai</title>
               ...
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12 ">
                        ...
                        <h3>
                          Tabel  <span class="fa-angle-right fa"></span> Data Edit List Partai
                        </h3>
              ...
              <div class="col-md-12 col-sm-12 top-10 padding-0">
                <div class="col-md-12 col-sm-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                    ...
                    <div class="panel-heading"><h3>Data Edit List Partai</h3></div>
                    <div class="panel-body">
                      <div class="table-responsive" >
                         <form action="<?php echo base_url('Penerimaan_kainjadi/editNewProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                          ...
                          <th class="col-md-1">Simpan</th>
                           ...
                           <tr>
                            <td>
                              ...
                              <input type="hidden" name="no_partai" value="<?php echo $result->no_partai; ?>">
                            </td>
                            <td><?php echo $result->nm_warna; ?></td>
                            <td><?php echo $result->setting; ?></td>
                            <td>
