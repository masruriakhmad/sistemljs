...
<head>
  ...
  <title>Edit Penerimaan Grey</title>
            ...
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Edit Penerimaan Grey
                        </h3>
                    </div>
                  </div>
              </div>
              ...
              ?>
                ...
                <form action="<?php echo base_url('Penerimaan_grey/export'); ?>" id="export_form" onSubmit="return validasi()"autocomplete="on" method="POST">
                  <input align="left" type="submit" id="import" name="import" value="Export Excel" class="btn btn-success" />
                </form>
              </div>
               <div class="col-md-4">
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Edit Penerimaan Grey</h3></div>
                    <div class="panel-body">
                      <div class="table-responsive">
                         <form action="<?php echo base_url('Penerimaan_grey/editProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                           ...
                           <tr>
                            <td>
                              <?php echo $result->no_tr_grey; ?>
                                <input type="hidden" name="no_tr_grey" value="<?php echo $result->no_tr_grey; ?>" required>
                              </td>
                            <td><?php echo $result->sku; ?></td>
                            <td>
                              <select  name="kd_kain" id="kd_kain">
                            ...
                            <td>
                              <input type="text" name="gramasi" value="<?php echo $result->gramasi; ?>" required>
                            </td>
                            <td><?php echo $result->kg_grey; ?></td>
                            <td>
                              <input type="text" name="bs_garis" value="<?php echo $result->bs_garis; ?>" required>
                            </td>
                            <td>
                              
                              <input type="text" name="bs_lubang" value="<?php echo $result->bs_lubang; ?>" required>
                            </td>
                            <td>
                              
                              <input type="text" name="ket" value="<?php echo $result->ket; ?>">
                            </td>
                            <td>
                              <select  name="no_wo" id="no_wo">
                                    <option value="<?php echo $result->no_wo; ?>"><?php echo $result->no_wo." | ".$result->nm_customer; ?></option>
                            ...
                            <td>
                              <input type="submit" class="btn btn-xs btn-success" value="Simpan">
                            </td>
