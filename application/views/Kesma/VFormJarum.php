    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Jarum/createProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Data Master Jarum
                        </h3>
                    </div>
                  <div class="col-md-12">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Tambah Data Master Jarum</h4>
                    </div>
                      ...
                      <div class="col-md-12">
                         <form class="form-horizontal">                           
                          <!--    <div class="form-group">
                              ...
                              <div class="form-group">
                                <div class="col-sm-6">
                                  <label class="control-label">Nama Jarum</label>
                                  <input class="form-control" id="nm_jarum" type="text" name="nm_jarum" placeholder="Diisi "><br>
                                  <label class="control-label">Merek Jarum</label>
                                  <input class="form-control" id="Merek_Jarum" type="text" name="Merek_Jarum" placeholder="Diisi "><br>
                                  <label class="control-label">Mesin</label>
                                  <input class="form-control" id="size" type="text" name="size" placeholder="Diisi "><br>
                                  <label class="control-label">Jumlah</label>
                                  <input class="form-control" id="jumlah" type="text" name="jumlah" placeholder="Boleh tidak Diisi "><br>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
