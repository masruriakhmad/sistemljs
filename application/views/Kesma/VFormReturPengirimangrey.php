...
<head>
  ...
  <title>Retur Pengiriman Grey</title>
...
<body id="mimin" class="dashboard" onload="setInterval('displayServerTime()', 1000);">
      ...
      <?php $this->load->view('menu2'); ?>
           ...
           <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-15">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Data Pengiriman Ulang Maklun
                        </h3>
                    </div>
                  </div>
              </div>
              <div class="panel-body">
                <h1>Pengiriman Ulang Maklun</h1>
              </div>

                  <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                         <form class="form-horizontal" action="<?php echo base_url('Pengiriman_grey/returProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST"> 
                      ...
                      <p><b><i>NB : Untuk Pengiriman Ulang Ke Maklun satu Partai Satu Surat Jalan !!!</i></b></p>
                      ...
                      <?php
                        ...
                        if($list>0)
                        {
                          ...
                          ?>
                           <tr>
                            <td>
                              <a href="<?php echo base_url('Pengiriman_grey/detailList/'.$row->no_partai.''); ?>" >
                            ...
                            <td>
                             <a href="<?php echo base_url('Pengiriman_grey/deleteListRetur/'.$row->no_partai.''); ?>" data-confirm="anda yakin ingin menghapus?" data-toogle="tooltip" title="Hapus transaksi">
                            ...
                            <div class="form-group">
                                <div class="col-sm-5">
                                  <label class="control-label">Nama Supir</label>
                                   <input class="form-control" id="nm_supir" type="text" name="nm_supir" placeholder="Diisi" value="" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-5">
                                  <label class="control-label">Alasan Retur</label>
                                   <textarea class="form-control" id="ket" type="text" name="ket" placeholder="Diisi" value="" required></textarea>
                                </div>
                            </div>
                      <input class="submit btn btn-primary" type="submit" value="Simpan"> 
                      
                     <a href="<?php echo base_url('Pengiriman_grey/deleteAllListRetur/'.$result1.''); ?>" data-confirm="anda yakin ingin menghapus?" data-toogle="tooltip" title="Hapus transaksi">
              ...
              <form action="<?php echo base_url('Pengiriman_grey/createListRetur'); ?>" method="post">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <select  class="form-control" name="no_partai" id="no_partai" data-live-search="true" required>
                                    <option value="">--Pilih--</option>
                                    <?php
  ...
  $(document).ready(function(){ // Ketika halaman sudah siap (sudah selesai di load)
    ...
    $("#no_partai").change(function(){ // Ketika user mengganti atau memilih data provinsi
      ...
      $.ajax({
        ...
        url: "<?php echo base_url("Pengiriman_grey/listGreyRetur"); ?>", // Isi dengan url/path file php yang dituju
