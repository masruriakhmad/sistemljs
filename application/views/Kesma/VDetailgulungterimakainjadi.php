...
<head>
  ...
  <title>Data Detail Nomor Gulung Penerimaan Kain Jadi</title>
               ...
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12 ">
                        ...
                        <h3>
                          Tabel  <span class="fa-angle-right fa"></span> Detail Nomor Gulung
                        </h3>
                ...
                <div class="col-md-12 col-sm-12">
                  ...
                  <!-- <div class="row"><div class="col-md-12 col-sm-12" id="responsive"></div></div>-->
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Detail Nomor Gulung</h3></div>
                    <div class="panel-body">
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            ...
                            <td>
                                 <a href="<?php echo base_url('Penerimaan_kainjadi/cetakLabelGulung/'.$row->no_tr_grey.''); ?>" data-confirm="Cetak Penerimaan ini?" data-toogle="tooltip" title="cetak transaksi">
                            ...
                            <?php if($this->session->userdata('level') != 'operator'){ ?>
                            <td>
                                 <a href="<?php echo base_url('Penerimaan_kainjadi/editPerGulungTampil/'.$row->no_tr_grey.''); ?>" title="edit kg">
