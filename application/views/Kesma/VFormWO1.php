...
//        validasi nip tidak boleh kosong (required)
        ...
        var setting=document.forms["myform"]["setting"].value;
...
//        validasi nip tidak boleh kosong (required)
        if (setting==null || setting=="")
          {
          alert("Setting harus diisi !");
          return false;
          };

        if (!setting.match(numbers))
          {
          alert("Setting harus angka  !");
          return false;
          };


        var jml_rol=document.forms["myform"]["jml_rol"].value;
        
//        membuat variabel numbers bernilai angka 0 s/d 9
        var numbers=/^[0-9]+$/;
        
//        validasi nip tidak boleh kosong (required)
        if (jml_rol==null || jml_rol=="")
          {
          alert("Jumlah Roll harus diisi !");
          return false;
          };

        if (!jml_rol.match(numbers))
          {
          alert("Jumlah Roll harus angka  !");
          return false;
          };            
//        ...
     }
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Data Master Benang
                        </h3>
                    </div>
                  <div class="col-md-10">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Tambah Data Master WO</h4>
                    </div>
                    <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                      <div class="col-md-12">
                         <form class="form-horizontal"action="<?php echo base_url('Wo/createProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">                           
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  <label class="control-label">Jenis Benang</label><br>
                                  <select  name="jenis_benang" id="jenis_benang">
                                    <option class="col-sm-3" value="">-Pilih-</option>
                                  <?php
                                  foreach ($result2->result() as $row) {
                                    echo "<option value='".$row->kd_jenis."'>".$row->jenis_benang."</option>";
                                  }    
                                ?>
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  <label class="control-label">Nama Warna</label><br>
                                  <select  name="nm_warna" id="nm_warna">
                                    <option class="col-sm-3" value="">-Pilih-</option>
                                  <?php
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="setting" type="text" name="setting" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/>
                              <div class="form-group">
                                <div class="col-sm-2">
                                  <label class="control-label">Jumlah Roll</label>
                                  <input class="form-control" id="jml_rol" type="text" name="jml_rol" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/>
