                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            ...
                            <td><?php echo $row->jml_rol;?></td>
                            <td><?php echo $row->proses_rol;?></td>
                            <td>
                            <button type="button" class="view_data btn btn-success btn-xs" data-toggle="modal" id="<?php echo $row->id;?>" data-target="#myModal">Detail</button>
                            </td>
                            <td>
                              <!--
                            <a href="<?php echo base_url('Wo/edit/'.$row->no_wo.''); ?>" data-toogle="tooltip" title="Edit">
                              <button class=" btn btn-circle btn-mn btn-primary" value="primary">
                                <span class="fa fa-edit"></span>
                              </button>
                            </a>
                          -->
                             <a href="<?php echo base_url('Wo/delete/'.$row->no_wo.''); ?>" data-confirm="anda yakin ingin menghapus?" data-toogle="tooltip" title="Hapus transaksi">
