...
<head>
  ...
  <title>Data Penerimaan grey</title>
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Data Penerimaan Grey
                        </h3>
                    </div>
                  </div>
              </div>
              <div class="col-md-6" style="margin-top:5px;">
                  <a href="<?php echo base_url('Penerimaan_grey/create'); ?>">
                    ...
                    <div class="panel-body">
                      ...
                      <thead style = "background-color :  #d6eaf8">
                        <tr>
                          ...
                          <th class="col-md-2">No. Tr. Grey</th>
                     <!-- <th class="col-md-2">Tanggal</th> -->
                      ...
                      <?php
                       ...
                       <!-- <td><?php echo $row->tgl; ?></td> -->
                            ...
                            <td><a href="<?php echo base_url('Produksi/editProduksi/'.$row->no_produksi.''); ?>" data-toogle="tooltip" title="Selesaikan">
                              <button class=" btn btn-circle btn-mn btn-primary" value="primary">
                                <span class="fa fa-edit"></span>
                              </button>
                           <!-- </a>
                             <a href="<?php echo base_url('Produksi/deleteProduksi/'.$row->no_produksi.''); ?>" data-confirm="Anda yakin ingin menghapus data ini?" data-toogle="tooltip" title="Hapus transaksi">
