    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Grey/createProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Data Master Grey
                        </h3>
                    </div>
                  <div class="col-md-10">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Tambah Data Master Grey</h4>
                    </div>
                          ...
                          <!--    <div class="form-group">
                              ...
                              <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input class="form-control" id="nm_kain" type="text" name="nm_kain" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
