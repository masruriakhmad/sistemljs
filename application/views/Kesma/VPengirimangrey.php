                ...
                <div class="col-md-11">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Data Pengiriman  Maklon</h3></div>
                    <div class="panel-body">
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            ...
                            <td>
                            <a href="<?php echo base_url('Pengiriman_grey/cetakDetailProses/'.$row->no_tr_maklun.''); ?>" data-confirm="Cetak  Detail Pengiriman ini?" data-toogle="tooltip" title="cetak Detail transaksi">
                            ...
                            <td>
                            <a href="<?php echo base_url('Pengiriman_grey/batalProses/'.$row->no_tr_maklun.''); ?>" data-confirm="Batalkan Pengiriman ini?" data-toogle="tooltip" title="hapus transaksi">
