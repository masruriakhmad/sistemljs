...
//        validasi nip tidak boleh kosong (required)
        ...
        if (!jumlah.match(numbers))
          {
          alert("Jumlah harus angka & tdak boleh 0 !");
          return false;
          };         
    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-20">
                    <form action="<?php echo base_url('Produksi/createProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Data Produksi
                        </h3>
                    </div>
                  <div class="col-md-20">
                          ...
                          <!--
                              <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input class="form-control" id="no_produksi" type="text"  name="no_produksi" placeholder="Diisi">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                            -->
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  ...
                                  <select  name="kd_benang" id="kd_benang">
                              ...
                              <div class="form-group">
                                <div class="col-md-1 col-sm-2">
                                  ...
                                  <select name="kd_mesin" id="kd_mesin" style="width: 200px;">
                                            <option value="">Pilih</option>
                                  </select>
                              <!--
                                  <select  name="kd_mesin" id="kd_mesin">
                                    <option value="dissabled diselected">--Pilih--</option>
                                  <?php
                              ...
                              <div class="form-group">
                                <div class="col-sm-4">
                                  <label class="control-label">Jumlah (Cones)</label>
...
<!-- Load librari/plugin jquery nya -->
  ...
  $(document).ready(function(){ // Ketika halaman sudah siap (sudah selesai di load)
    ...
    $("#kd_benang").change(function(){ // Ketika user mengganti atau memilih data provinsi
      $("#kd_mesin").hide(); // Sembunyikan dulu combobox kota nya
      $("#loading").show(); // Tampilkan loadingnya
    
      $.ajax({
        type: "POST", // Method pengiriman data bisa dengan GET atau POST
        url: "<?php echo base_url("Produksi/listMesin"); ?>", // Isi dengan url/path file php yang dituju
        data: {kd_benang : $("#kd_benang").val()}, // data yang akan dikirim ke file yang dituju
        dataType: "json",
        ...
        success: function(response){ // Ketika proses pengiriman berhasil
          ...
          $("#kd_mesin").html(response.list_kota).show();
        },
    ...
    $("#kd_benang").change(function(){ // Ketika user mengganti atau memilih data provinsi
      ...
      $.ajax({
        ...
        success: function(response){ // Ketika proses pengiriman berhasil
          ...
          // set isi dari combobox kota
          // lalu munculkan kembali combobox kotanya
          $("#kd_mesin").html(response.list_mesin).show();
        },
        error: function (xhr, ajaxOptions, thrownError) { // Ketika ada error
          alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError); // Munculkan alert error
        }
