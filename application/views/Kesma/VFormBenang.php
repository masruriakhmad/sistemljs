    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Benang/createProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                          ...
                          <!--    <div class="form-group">
                              ...
                              <div class="form-group">
                                <div class="col-sm-6">
                                  ...
                                  <input class="form-control" id="jenis_benang" type="text" name="jenis_benang" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
