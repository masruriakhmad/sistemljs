...
<head>
  ...
  <title>Detail Stock Kain Jadi</title>
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span>Detail Stock Kain Jadi
                        </h3>
                    </div>
                  </div>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Detail Stock Kain Jadi</h3></div>
                    <div class="panel-body">
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            ...
                            <td><?php 
                            echo $row->kg_grey; 
                            $total_kg_grey += $row->kg_grey;
                            ?></td>
                            <td><?php 
                            echo $row->kg_fin; 
                            $total_kg_fin += $row->kg_fin;
                            ?></td>
                            <td>
                            <?php
                                $grey = number_format($row->kg_grey);
                                $fin = number_format($row->kg_fin);
                                if($grey==NULL OR $grey==0){

                                  echo number_format(0,2);
                                }else{
                                echo number_format(($fin-$grey)/$grey*100,2);
                              }
                            ?>
                            %
                            </td>
                      ...
                      <tr>
                        ...
                        <td><b><?php echo $total_kg_grey; ?></b></td>
                        <td><b><?php echo $total_kg_fin; ?></b></td>
                        <td colspan="3"></td>
                      </tr>
                        </table>
