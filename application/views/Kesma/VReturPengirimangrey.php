          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
              ...
              <div class="col-md-2" style="margin-top:5px;">
                  <a href="<?php echo base_url('Pengiriman_grey/retur'); ?>">
                  <button class="btn ripple-infinite btn-gradient btn-danger">
                    <div>
                    <span>Kirim Ulang Greige</span>
                    </div>
                  </button>
                  </a>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Data Pengiriman Ulang Maklon</h3></div>
                    <div class="panel-body">
                      ...
                      <?php
                        ...
                        if($retur->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            <td>
                              <a href="<?php echo base_url('Partai/detailMaklun/'.$row->no_tr_maklun.''); ?>" >
                              <?php echo $row->no_tr_maklun; ?>
                              </a>
                            </td>
                            ...
                            <td>
                            <a href="<?php echo base_url('Pengiriman_grey/cetakProsesRetur/'.$row->no_tr_maklun.''); ?>" data-confirm="Cetak Pengiriman ini?" data-toogle="tooltip" title="cetak transaksi">
                            ...
                            <td>
                            <a href="<?php echo base_url('Pengiriman_grey/cetakDetailProsesRetur/'.$row->no_tr_maklun.''); ?>" data-confirm="Cetak  Detail Pengiriman ini?" data-toogle="tooltip" title="cetak Detail transaksi">
                            ...
                            <td>
                            <a href="<?php echo base_url('Pengiriman_grey/batalProsesRetur/'.$row->no_tr_maklun.''); ?>" data-confirm="Batalkan Pengiriman ini?" data-toogle="tooltip" title="hapus transaksi">
