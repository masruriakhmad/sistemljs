...
<head>
  ...
  <title>Data Detail Penerimaan Kain Jadi</title>
               ...
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12 ">
                        ...
                        <h3>
                          Tabel  <span class="fa-angle-right fa"></span> Detail Penerimaan Kain Jadi
                        </h3>
                ...
                <div class="col-md-12 col-sm-12">
                  ...
                  <!-- <div class="row"><div class="col-md-12 col-sm-12" id="responsive"></div></div>-->
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Detail Penerimaan Kain</h3></div>
                    <div class="panel-body">
