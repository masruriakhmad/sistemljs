...
<body id="mimin" class="dashboard" onload="setInterval('displayServerTime()', 1000);">
    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  ...
                  <div class="col-md-20">
                  <div class="col-md-20 panel">
                    <div class="col-md-20 panel-heading">
                      <h4>Tambah Data Pengiriman Grey</h4>
                    </div>
                         ...
                         <form class="form-horizontal"> 
                          ...
                          <div class="form-group">
                                <div class="col-md-2 col-sm-3">
                                  ...
                                  <select name="kd_customer" id="kd_customer">
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  ...
                                  <input class="form-control" id="no_mobil" type="text" name="no_mobil" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  ...
                                  <input class="form-control" id="nm_supir" type="text" name="nm_supir" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  <label class="control-label">No Transaksi Grey</label>
    ...
    <br/><br/> <br/><br/>
                              ...
                              <br/><br/> <br/><br/>
                                ...
                                <div class="form-group">
                                <div class="col-sm-3">
                                  <label class="control-label">Kode Benang</label>
                                  <input class="form-control" id="kd_jenis" type="text" name="kd_jenis" value="<?php echo $edit['kd_jenis'];?>" /readonly>
                              ...
                              <br/><br/> <br/><br/>
                               ...
                               <div class="form-group">
                                <div class="col-sm-3">
                                  ...
                                  <select name="kd_kain" id="kd_kain" style="width: 200px;">
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  ...
                                  <select  name="kd_gudang" id="kd_gudang">
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  ...
                                  <input class="form-control" id="operator" type="text" name="operator" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                               ...
                               <div class="form-group">
                                <div class="col-sm-3">
                                  <label class="control-label">Nama Customer</label><br>
                                  <select  name="kd_customer" id="kd_customer">
                                    <option class="col-sm-3" value="">--Pilih--</option>
                                  <?php
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  ...
                                  <input class="form-control" id="no_wo" type="text" name="no_wo" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  ...
                                  <input class="form-control" id="gramasi" type="text" name="gramasi" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  ...
                                  <input class="form-control" id="kg_grey" type="text" name="kg_grey" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
...
<script src="<?php echo base_url('view/asset/js/jquery-1.8.3.js')?>"></script>
<script src="<?php echo base_url('view/asset/js/script.js')?>"></script>
