      ...
      <?php $this->load->view('menu2'); ?>        
          <!-- end: Left Menu -->
            ...
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Data Master Mesin
                        </h3>
                    </div>
                  </div>
              </div>
              ...
              ?>
                <div class="col-md-1">
                <form action="<?php echo base_url('Mesin/export'); ?>" id="export_form" onSubmit="return validasi()"autocomplete="on" method="POST">
                  <input align="center" type="submit" id="import" name="import" value="Export Excel" class="btn btn-success" />
                </form>
              </div>
               <div class="col-md-4">
                <form action="<?php echo base_url('Mesin/import'); ?>" id="import_form" onSubmit="return validasi()"autocomplete="on" method="POST">
                  <div class="col-md-4">
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Data Mesin</h3></div>
                    <div class="panel-body">
                      ...
                      <?php
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            <td><?php echo $row->kd_mesin; ?></td>
                            <td><?php echo $row->no_mesin; ?></td>
                            <td><?php echo $row->merk; ?></td>
                            <td><?php echo $row->trak; ?></td>
                            <td><?php echo $row->no_seri; ?></td>
                            <td><?php echo $row->tahun; ?></td>
                            <td><?php echo $row->diameter; ?></td>
                            <td><?php echo $row->gauge; ?></td>
                            <td><?php echo $row->feeder; ?></td>
                            <td><?php echo $row->jml_jarum; ?></td>
                            <td>
                            <a href="<?php echo base_url('Mesin/edit/'.$row->kd_mesin.''); ?>" data-toogle="tooltip" title="Edit">
                              <button class=" btn btn-circle btn-mn btn-primary" value="primary">
                                <span class="fa fa-edit"></span>
                              </button>
                            </a>
                             <a href="<?php echo base_url('Mesin/delete/'.$row->kd_mesin.''); ?>" data-confirm="anda yakin ingin menghapus?" data-toogle="tooltip" title="Hapus transaksi">
