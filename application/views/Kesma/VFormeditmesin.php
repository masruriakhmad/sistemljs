...
<head>
  ...
  <title>Form Edit Master Grey</title>
    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Mesin/update'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Edit Data Master Grey
                        </h3>
                    </div>
                  <div class="col-md-10">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Edit Data Master Grey</h4>
                    </div>
                      ...
                      <div class="col-md-12">
                         <form class="form-horizontal">                           
                          <div class="form-group">
                                <div class="col-sm-2">
                                  <label class="control-label">Kode Mesin</label>
                                  <input class="form-control" id="kd_mesin" type="text" name="kd_mesin" placeholder="Diisi"
                                  value="<?php echo $edit['kd_mesin']; ?>"/readOnly>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="no_mesin" type="text" name="no_mesin" placeholder="Diisi" value="<?php echo $edit['no_mesin']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="merk" type="text" name="merk" placeholder="Diisi" value="<?php echo $edit['merk']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  <label class="control-label">Trak</label>
                                  <input class="form-control" id="trak" type="text" name="trak" placeholder="" value="<?php echo $edit['trak']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="no_seri" type="text" name="no_seri" placeholder="Diisi" value="<?php echo $edit['no_seri']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="tahun" type="text" name="tahun" placeholder="Diisi" value="<?php echo $edit['tahun']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="diameter" type="text" name="diameter" placeholder="Diisi" value="<?php echo $edit['diameter']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="gauge" type="text" name="gauge" placeholder="Diisi" value="<?php echo $edit['gauge']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="feeder" type="text" name="feeder" placeholder="Diisi" value="<?php echo $edit['feeder']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  <label class="control-label">Jumlah Jarum</label>
                                  <input class="form-control" id="jml_jarum" type="text" name="jml_jarum" placeholder="" value="<?php echo $edit['jml_jarum']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
