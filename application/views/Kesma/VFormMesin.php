    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Mesin/createProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                  ...
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Tambah Data Master Benang</h4>
                    </div>
                         ...
                         <form class="form-horizontal">                           
                          <!--    <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="tgl" type="text" name="tgl" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/> -->
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="no_mesin" type="text" name="no_mesin" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="merk" type="text" name="merk" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="trak" type="text" name="trak" placeholder="">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="no_seri" type="text" name="no_seri" placeholder="Diisi">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="tahun" type="text" name="tahun" placeholder="Diisi">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="diameter" type="text" name="diameter" placeholder="Diisi">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="gauge" type="text" name="gauge" placeholder="Diisi">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="feeder" type="text" name="feeder" placeholder="Diisi">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="jml_jarum" type="text" name="jml_jarum" placeholder="">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
