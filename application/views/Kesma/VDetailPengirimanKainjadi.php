...
<head>
  ...
  <title>Data Detail Pengiriman Kain jadi</title>
      ...
      <?php $this->load->view('menu2'); ?>        
          <!-- end: Left Menu -->
            ...
            <div id="content" >
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12 ">
                        ...
                        <h3>
                          Tabel  <span class="fa-angle-right fa"></span> Detail Pengiriman Kain Jadi
                        </h3>
               ...
               <div class="col-sm-12">
                <a href="<?php echo base_url('Pengiriman_kainjadi'); ?>" >
                ...
                <div class="col-md-12 col-sm-12">
                  ...
                  <!-- <div class="row"><div class="col-md-12 col-sm-12" id="responsive"></div></div>-->
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Detail Pengiriman Kain Jadi</h3></div>
                    <div class="panel-body">
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            ...
                            <td>
                              <?php echo $row->nm_kain.' Gramasi '.$row->gramasi.'  '.$row->gramasi.' Setting '.$row->setting.'"<br> W/'.$row->nm_warna; ?>
                            </td>
                            <td>
