...
<head>
  ...
  <title>Data Detail Stock Maklun</title>
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Data Detail Stock Maklun
                        </h3>
                    </div>
                  </div>
              </div>
              <div class="col-md-6" style="margin-top:5px;">
                  <a href="<?php echo base_url('Stock_kain/maklun'); ?>">
                  <button class="btn ripple-infinite btn-gradient btn-info">
                    <div>
                    <span>Kembali Ke Stock</span>
                    </div>
                  </button>
                  </a>
              </div>
