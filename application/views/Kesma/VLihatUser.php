...
<script src="<?php echo base_url('view/assets/js/plugins/jquery.datatables.min.js'); ?>"></script>
<script src="<?php echo base_url('view/assets/js/plugins/datatables.bootstrap.min.js'); ?>"></script>
