          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Data Master Vendor
                        </h3>
                    </div>
                  </div>
              </div>
              <div class="col-md-12" style="margin-top:5px;">
                <div class="col-md-1">
                  <a href="<?php echo base_url('Vendors/create'); ?>">
              ...
              ?>
                <div class="col-md-1">
                <form action="<?php echo base_url('Vendors/export'); ?>" id="export_form" onSubmit="return validasi()"autocomplete="on" method="POST">
                  <input align="center" type="submit" id="import" name="import" value="Export Excel" class="btn btn-success" />
                </form>
              </div>
               <div class="col-md-4">
                <form action="<?php echo base_url('Vendors/import'); ?>" id="import_form" onSubmit="return validasi()"autocomplete="on" method="POST">
                  <div class="col-md-4">
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            ...
                            <td>
                            <a href="<?php echo base_url('Vendors/edit/'.$row->kd_vendor.''); ?>" data-toogle="tooltip" title="Edit">
                              <button class=" btn btn-circle btn-mn btn-primary" value="primary">
                                <span class="fa fa-edit"></span>
                              </button>
                            </a>
                             <a href="<?php echo base_url('Vendors/delete/'.$row->kd_vendor.''); ?>" data-confirm="anda yakin ingin menghapus?" data-toogle="tooltip" title="Hapus transaksi">
