                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Data Stock Benang
                        </h3>
                    </div>
                  </div>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Data Stock Benang</h3></div>
                    <div class="panel-body">
                      ...
                      <?php
                       ...
                       <!-- <td><?php echo $row->kd_user; ?></td> -->
                        ...
                        <!--<td><?php echo $row->ket; ?></td> -->
                          ...
                          -->
                          <!--
                            <a href="<?php echo base_url('Penerimaan_benang/batalProses/'.$row->no_tr_benang.''); ?>" data-confirm="Batalkan Pnenerimaan ini?" data-toogle="tooltip" title="Hapus transaksi">
