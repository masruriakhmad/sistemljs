...
<head>
  ...
  <title>Detail Stock Maklun</title>
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span>Detail Stock Maklun
                        </h3>
                    </div>
                  </div>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Detail Stock Maklun</h3></div>
                    <div class="panel-body">
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            <td><?php echo $no;?></td>
                            <td>
                              <a href="<?php echo base_url('Stock_kain/tampilDetailMaklunPerPartai/'.$row->kd_subcon.$row->kd_kain); ?>" >
                            ...
                            <td>
                              <?php 
                                    echo number_format($row->jumlah_kg_grey,2); 
