...
<head>
  ...
  <title>Data Penerimaan Jarum</title>
                  ...
                  <div class="panel-body">
                    <div class="col-md-15">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Data Penerimaan Jarum
                    </div>
                  </div>
              </div>
              <div class="col-md-12" style="margin-top:5px;">
                  <a href="<?php echo base_url('Penerimaan_jarum/create'); ?>">
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Data Penerimaan Jarum</h3></div>
                    <div class="panel-body">
