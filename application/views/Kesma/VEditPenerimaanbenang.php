...
<head>
  ...
  <title>Edit Penerimaan Benang</title>
...
//        validasi nip harus 18 digit pakai length javascript
        if (no_tr_barang.length>10)
          {
          alert("Kesalahan Kode Gudang");
          return false;
          };

          var kd_benang=document.forms["myform"]["kd_benang"].value;
        
//        membuat variabel numbers bernilai angka 0 s/d 9
        var numbers=/^[0-9][A-Za-z]+$/;
        
//        validasi nip tidak boleh kosong (required)
        if (kd_benang==null || kd_benang=="")
          {
          alert("Kode Benang tidak boleh kosong !");
          return false;
          };
...
//        validasi nip harus 18 digit pakai length javascript
        if (kd_benang.length>30)
          {
          alert("No transaksi maksimal 30 digit");
          return false;
          };

          var kd_vendor=document.forms["myform"]["kd_vendor"].value;
        
//        membuat variabel numbers bernilai angka 0 s/d 9
        var numbers=/^[0-9][A-Za-z]+$/;
        
//        validasi nip tidak boleh kosong (required)
        if (kd_vendorg==null || kd_vendor=="")
          {
    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Penerimaanbenang/update/'.$edit['no_tr_benang'].''); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Edit Data Penerimaan Benang
                        </h3>
                    </div>
                  <div class="col-md-10">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Edit Data Penerimaan Benang</h4>
                    </div>
                      ...
                      <div class="col-md-12">
                         <form class="form-horizontal">
                              <div class="form-group">
                                <div class="col-sm-4">
                                  <label class="control-label">No. Tr. Benang</label>
                                  <input class="form-control" id="no_tr_benang" type="text"  name="no_tr_benang" placeholder="Diisi">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="kd_gudang" type="text" name="kd_gudang" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="kd_benang" type="text" name="kd_benang" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="kd_vendor" type="text" name="kd_vendor" placeholder="Diisi ">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
