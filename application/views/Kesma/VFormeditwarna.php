...
<head>
  ...
  <title>Form Edit Master Warna</title>
    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Warna/update'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Edit Master Warna
                        </h3>
                    </div>
                  <div class="col-md-10">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Edit Data Master Warna</h4>
                    </div>
                         ...
                         <form class="form-horizontal">                           
                          <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="kd_warna" type="text" name="kd_warna" placeholder="Diisi "value="<?php echo $edit->kd_warna; ?>"/readOnly>
                                </div>
                              </div>
                              <br/><br/> <br/><br/> 
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="nm_warna" type="text" name="nm_warna" placeholder="Diisi " value="<?php echo $edit->nm_warna; ?>" required>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
