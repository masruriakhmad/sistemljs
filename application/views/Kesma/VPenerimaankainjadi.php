                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            ...
                            <td>
                            <a href="<?php echo base_url('Penerimaan_kainjadi/cetakLabelMasal/'.$row->no_tr_kainjadi.''); ?>" data-confirm="Cetak Barcode ?" data-toogle="tooltip" title="cetak transaksi">
                            ...
                            <a href="<?php echo base_url('Penerimaan_kainjadi/cetakProses/'.$row->no_tr_kainjadi.''); ?>" data-confirm="Cetak Penerimaan ini?" data-toogle="tooltip" title="cetak transaksi">
                              ...
                              <td>
                            <a href="<?php echo base_url('Penerimaan_kainjadi/cetakDetailProses/'.$row->no_tr_kainjadi.''); ?>" data-confirm="Cetak Detail Penerimaan ini?" data-toogle="tooltip" title="cetak transaksi">
                            ...
                            <td>
                            <a href="<?php echo base_url('Penerimaan_kainjadi/batalProses/'.$row->no_tr_kainjadi.''); ?>" data-confirm="Batalkan Penerimaan ini?" data-toogle="tooltip" title="batalkan transaksi">
