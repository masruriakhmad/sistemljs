    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Pengiriman_grey/createProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Data Produksi Penerimaan Grey
                        </h3>
                    </div>
                  <div class="col-md-10">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Data Produksi Penerimaan Grey</h4>
                    </div>
                      ...
                      <div class="col-md-12">
                        <form class="form-horizontal">                           
                              <div class="form-group">
                                <div class="col-sm-7">
                                  <label class="control-label">Nomor Produksi</label>
                                  <input class="form-control" id="no_produksi" type="text" name="no_produksi" placeholder="Diisi" value="<?php echo $edit['no_produksi']; ?>" /readOnly>
                                </div>
                              </div>
                              <br/> 
                              <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  ...
                                  <input class="form-control" id="nm_benang" type="text" name="nm_benang" placeholder="Diisi" value="<?php echo $edit['jenis_benang']; ?>" /readOnly>
                                </div>
                              </div>
                              <br/><br/> 
                              <br/><br/>
                             ...
                             <div class="form-group">
                                <div class="col-md-5">
                                  <label class="control-label">Kain Jadi</label>
                              ...
                              <div class="form-group">
                                <div class="col-sm-3">
                                  ...
                                  <select  name="kd_gudang" id="kd_vendor">
                                    <option value="G001">GUDANG PRODUKSI</option>
                                  <?php
                              ...
                              <div class="form-group">
                                <div class="col-sm-10">
                                  ...
                                  <textarea class="form-control" id="kg" type="text" name="kg" placeholder="Diisi "></textarea>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
