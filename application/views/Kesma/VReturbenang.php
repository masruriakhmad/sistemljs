                  ...
                  <div class="panel-body">
                    <div class="col-md-15">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Data Retur Benang
                        </h3>
                    </div>
                  </div>
              </div>
              <div class="col-md-1" style="margin-top:5px;">
                  <a href="<?php echo base_url('Retur_benang/create'); ?>">
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Data Retur Benang</h3></div>
                    <div class="panel-body">
                      ...
                      <thead style = "background-color :  #d6eaf8">
                        <tr>                       
                          <th class="col-sm-1">No.Retur Benang</th>
                          <th class="col-sm-2">Tanggal</th>
                          <th class="col-sm-1">Nama Benang</th>
                          <th class="col-sm-3">Nama Vendor</th>
                          <th class="col-sm-1">Jumlah (Kg)</th>
                      ...
                      <?php
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            <td><?php echo $row->no_retur_benang; ?></td>
                            ...
                            <td>
                            <a href="<?php echo base_url('Retur_benang/cetakProses/'.$row->no_retur_benang.''); ?>" data-confirm="Cetak Surat Jalan ini?" data-toogle="tooltip" title="cetak transaksi">
                            ...
                            <td>
                              <!--<a href="<?php echo base_url('Retur_benang/batalProses/'.$row->no_tr_benang.''); ?>" data-toogle="tooltip" title="Edit">
                              <button class=" btn btn-circle btn-mn btn-primary" value="primary">
                                <span class="fa fa-edit"></span>
                              </button>
                            </a>
                          -->
                            <a href="<?php echo base_url('Retur_benang/batalProses/'.$row->no_retur_benang.''); ?>" data-confirm="Batalkan Retur ini?" data-toogle="tooltip" title="Hapus transaksi">
