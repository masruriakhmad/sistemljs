...
<head>
  ...
  <title>Form Edit Master Benang</title>
    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Customer/update'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Edit Master Customer
                        </h3>
                    </div>
                  <div class="col-md-10">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Edit Data Master Customer</h4>
                    </div>
                         ...
                         <form class="form-horizontal">                           
                          <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input class="form-control" id="kd_customer" type="text" name="kd_customer" placeholder="Diisi "value="<?php echo $edit['kd_customer']; ?>"/readOnly>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              <div class="form-group">
                                <div class="col-sm-4">
                                  <label class="control-label">NIK/NPWPr</label>
                                  <input class="form-control" id="nik" type="text" name="nik" placeholder="Diisi "value="<?php echo $edit['nik']; ?>" required>
                                </div>
                              </div>
                              <br/><br/> <br/><br/> 
                              <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input class="form-control" id="nm_customer" type="text" name="nm_customer" placeholder="Diisi " value="<?php echo $edit['nm_customer']; ?>" required>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input class="form-control" id="alamat" type="text" name="alamat" placeholder="Diisi " value="<?php echo $edit['alamat']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                               ...
                               <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input class="form-control" id="kota" type="text" name="kota" placeholder="Diisi " value="<?php echo $edit['kota']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                               ...
                               <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input class="form-control" id="no_telp" type="text" name="no_telp" placeholder="Diisi " value="<?php echo $edit['no_telp']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>

                            <div class="col-md-12">
                              <input class="submit btn btn-danger" type="submit" value="Update">
                           </div>
                  </form>
                </div>
              </div>
