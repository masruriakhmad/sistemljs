...
<head>
  ...
  <title>Data Stock Kain Jadi</title>
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span>Data Stock Kain Jadi
                        </h3>
                    </div>
                  </div>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Data Stock Kain Jadi</h3></div>
                    <div class="panel-body">
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            <td><?php echo $no;; ?></td>
                            <td>
                              <a href="<?php echo base_url('Stock_kain/tampilDetailKainJadi/'.$row->kd_kain.$row->no_partai); ?>" >
                            ...
                            <td><?php echo $row->setting; ?></td>
                             <td>
                              <?php echo number_format($jml_kg_grey = $row->jumlah_kg_grey); 
                               $total_kg_grey    += $jml_kg_grey;
                              ?> 
                            </td>
                            <td>
                              <?php echo number_format($jml_kg_fin = $row->jumlah_kg_fin,2); 
                               $total_kg_fin    += $jml_kg_fin;
                              ?> 
                            </td>
                            <td>
                              <?php echo $jml_rol = $row->jumlah_rol; 
                               $total    += $jml_rol;
                              ?> 
                            </td>
                      ...
                      ?>
                       <tr>
                        ...
                        <td></td>
                        <td><B>Total</B></td>
                        <td><b><?php echo number_format($total_kg_grey); ?></b></td>
                        <td><b><?php echo number_format($total_kg_fin); ?></b></td>
