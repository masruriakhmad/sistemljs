...
<head>
  ...
  <title>Data Penggunaan Jarum</title>
                  ...
                  <div class="panel-body">
                    <div class="col-md-15">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Data Penggunaan Jarum
                    </div>
                  </div>
              </div>
              <div class="col-md-12" style="margin-top:5px;">
                  <a href="<?php echo base_url('PenggunaanJarum/create'); ?>">
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Data Penggunaan Jarum</h3></div>
                    <div class="panel-body">
                   ...
                   -->
                      ...
                      <?php
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          -->
                            <a href="<?php echo base_url('PenggunaanJarum/batalProses/'.$row->id.''); ?>" data-confirm="Batalkan Penggunaan ini?" data-toogle="tooltip" title="Hapus transaksi">
