...
//        validasi nip harus 18 digit pakai length javascript
        if (nama_kriteria.length>30)
          {
          alert("Nama Kriteria maksimal 30 digit");
          return false;
          };
...
//        my form adalah id dari form, lihat baris 5
//        nip adalah id inputan, lihat baris 6
        var bobot_kriteria=document.forms["myform"]["bobot_kriteria"].value;
        
//        membuat variabel numbers bernilai angka 0 s/d 9
        var numbers=/^[0-9]+$/;
        
//        validasi nip tidak boleh kosong (required)
        if (bobot_kriteria==null || bobot_kriteria=="")
          {
          alert("Bobot Kriteria tidak boleh kosong !");
          return false;
          };
          
//        validasi nip harus berupa angka
//        dengan membandingkan dengan variabel number yang dibuat pada baris 21
        if (!bobot_kriteria.match(numbers))
          {
          alert("Bobot Kriteria harus angka !");
          return false;
          };
          
//        validasi nip harus 18 digit pakai length javascript
        if (bobot_kriteria.length>2)
          {
          alert("Bobot Kriteria maksimal 2 digit");
          return false;
          };
    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Kriteria/createProcess'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Data Kriteria
                        </h3>
                    </div>
                  <div class="col-md-10">
                         ...
                         <form class="form-horizontal">
                              <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input class="form-control" id="nama_kriteria" type="text"  name="nama_kriteria" placeholder="Nama kriteria">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              ...
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="bobot_kriteria" type="text" name="bobot_kriteria" placeholder="Diisi angka">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                            <div class="col-md-12">
