...
<head>
  ...
  <title>Data Master Vendor</title>
          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Data Master Vendor Jarum
                        </h3>
                    </div>
                  </div>
              </div>
              <div class="col-md-12" style="margin-top:5px;">
                <div class="col-md-1">
                  <a href="<?php echo base_url('Vendorjarum/create'); ?>">
              ...
              ?>
                <div class="col-md-1">
                <form action="<?php echo base_url('Vendorjarum/export'); ?>" id="export_form" onSubmit="return validasi()"autocomplete="on" method="POST">
                  <input align="center" type="submit" id="import" name="import" value="Export Excel" class="btn btn-success" />
                </form>
              </div>
               <div class="col-md-4">
                <form action="<?php echo base_url('Vendorjarum/import'); ?>" id="import_form" onSubmit="return validasi()"autocomplete="on" method="POST">
                  <div class="col-md-4">
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading"><h3>Data Vendor</h3></div>
                    <div class="panel-body">
                      ...
                      <thead style = "background-color :  #d6eaf8">
                        <tr>
                          ...
                          <th class="col-md-1">Kode Vendor</th>
                          <th >Nama Vendor</th>
                          <th >Alamat</th>
                      ...
                      <?php
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            <td><?php echo $no; ?></td>
                            <td><?php echo $row->kd_vendorjarum; ?></td>
                            <td><?php echo $row->nm_vendorjarum; ?></td>
                            <td><?php echo $row->alamat; ?></td>
                            <td>
                            <a href="<?php echo base_url('Vendorjarum/edit/'.$row->kd_vendorjarum.''); ?>" data-toogle="tooltip" title="Edit">
                              <button class=" btn btn-circle btn-mn btn-primary" value="primary">
                                <span class="fa fa-edit"></span>
                              </button>
                            </a>
                             <a href="<?php echo base_url('Vendorjarum/delete/'.$row->kd_vendorjarum.''); ?>" data-confirm="anda yakin ingin menghapus?" data-toogle="tooltip" title="Hapus transaksi">
...
$(document).ready(function(){ 
  ...
  $('#import_form').on('submit', function(event){
    ...
    $.ajax({
      ...
      url:"<?php echo base_url() ?>Vendors/import",
