...
<head>
  ...
  <title>Data Master Customer</title>
    ...
    <?php $this->load->view('menu2'); ?>        
          <!-- end: Left Menu -->
            ...
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span> Data Master Customer
                        </h3>
                    </div>
                  </div>
              </div>
              ...
              ?>
                <div class="col-md-1">
                <form action="<?php echo base_url('Customer/export'); ?>" id="export_form" onSubmit="return validasi()"autocomplete="on" method="POST">
                  <input align="center" type="submit" id="import" name="import" value="Export Excel" class="btn btn-success" />
                </form>
              </div>
               <div class="col-md-4">
                <form action="<?php echo base_url('Customer/import'); ?>" id="import_form" onSubmit="return validasi()"autocomplete="on" method="POST">
                  <div class="col-md-4">
                    ...
                    <div class="panel-body">
                      ...
                      <thead style = "background-color :  #d6eaf8">
                        <tr>
                          ...
                          <th >Kota</th>
                          <th >No. Telp</th>
                          <th class="col-md-1" >Edit/Hapus</th>                        
                        </tr>
                      </thead>
                      <?php
                        $no = 1;
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            ...
                            <td>
                            <a href="<?php echo base_url('Customer/edit/'.$row->kd_customer.''); ?>" data-toogle="tooltip" title="Edit">
                              <button class=" btn btn-circle btn-mn btn-primary" value="primary">
                                <span class="fa fa-edit"></span>
                              </button>
                            </a>
                             <a href="<?php echo base_url('Customer/delete/'.$row->kd_customer.''); ?>" data-confirm="anda yakin ingin menghapus?" data-toogle="tooltip" title="Hapus Customer">
...
$(document).ready(function(){ 
  ...
  $('#import_form').on('submit', function(event){
    ...
    $.ajax({
      ...
      url:"<?php echo base_url() ?>Customer/import",
