    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Benang/update'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Edit Master Benang
                        </h3>
                    </div>
                  <div class="col-md-10">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Edit Data Master Benang</h4>
                    </div>
                         ...
                         <form class="form-horizontal">                           
                          <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="kd_jenis" type="text" name="kd_jenis" placeholder="Diisi "value="<?php echo $edit['kd_jenis']; ?>"/readOnly>
                                </div>
                              </div>
                              <br/><br/> <br/><br/> 
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="jenis_benang" type="text" name="jenis_benang" placeholder="Diisi " value="<?php echo $edit['jenis_benang']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
