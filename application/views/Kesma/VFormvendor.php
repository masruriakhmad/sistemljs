    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Vendors/createProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                         ...
                         <form class="form-horizontal">                           
                              <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input class="form-control" id="nm_vendor" type="text" name="nm_vendor" placeholder="Diisi " required>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              <div class="form-group">
