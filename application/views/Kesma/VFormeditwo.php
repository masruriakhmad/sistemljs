              ...
              <div class="panel-body">
                <h1>Edit Work Order</h1>
                  ...
                  <div class="col-md-12 panel-body" style="padding-bottom:30px;">
                          ...
                          <div class="form-group">
                                <div class="col-sm-5">
                                  <label class="control-label">Nomor Work Order</label>
                                   <input class="form-control" id="no_wo" type="text" name="no_wo" placeholder="" value="<?php echo $result->no_wo;?>" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-5">
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            ...
                            <td>
                            <!--
                            <a href="<?php echo base_url('Wo/edit/'.$row->kd_jenis.''); ?>" data-toogle="tooltip" title="Edit">
                    ...
                    <!--
          <a href="<?php echo base_url('Partai/delete/'.$result1.''); ?>" data-confirm="Batalkan Transaksi ini?" data-toogle="tooltip" title="Hapus transaksi">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="col-sm-10">
                                   <select  class="form-control" name="kd_jenis" id="kd_jenis" required>
                                    <option value="">--Pilih--</option>
                                    <?php
