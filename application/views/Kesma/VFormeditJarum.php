    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Jarum/update'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Edit Master Jarum
                        </h3>
                    </div>
                  <div class="col-md-10">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Edit Data Master Jarum</h4>
                    </div>
                         ...
                         <form class="form-horizontal">                           
                          <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="kd_jarum" type="text" name="kd_jarum" placeholder="Diisi "value="<?php echo $edit['kd_jarum']; ?>"/readOnly>
                                </div>
                              </div>
                              <br/><br/> <br/><br/> 
                              <div class="form-group">
                                <div class="col-sm-2">
                                  ...
                                  <input class="form-control" id="nm_jarum" type="text" name="nm_jarum" placeholder="Diisi " value="<?php echo $edit['nm_jarum']; ?>"><br>
                                  <label class="control-label">Ukuran</label>
                                  <input class="form-control" id="size" type="text" name="size" placeholder="Diisi " value="<?php echo $edit['size']; ?>"><br>
                                  <label id="jumlah" name="jumlah" value="<?php echo $edit['jumlah']; ?> " hiden ="hiden"></label>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
