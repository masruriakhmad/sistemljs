          ...
          <!-- end: Left Menu -->
            ...
            <div id="content" >
              ...
              <div class="col-md-12 " style="margin-top:5px;">
                  <a href="<?php echo base_url('Produksi/create'); ?>">
                    ...
                    <div class="panel-body">
                      ...
                      <?php
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            ...
                            <td>
                             ...
                             <a href="<?php echo base_url('Produksi/topUp/'.$row->no_produksi.''); ?>" data-toogle="tooltip" title="Top up">
                            ...
                            <td>
                             ...
                             <a href="<?php echo base_url('Produksi/editProduksi/'.$row->no_produksi.''); ?>" data-toogle="tooltip" title="cut">
                         ...
                         <td>
                             <a href="<?php echo base_url('Produksi/selesaiProduksi/'.$row->no_produksi.''); ?>" data-confirm="Anda yakin ingin menyelesaikan produksi ini?" data-toogle="tooltip" title="selesaikan transaksi">
