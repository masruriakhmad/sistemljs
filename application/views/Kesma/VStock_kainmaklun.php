                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Tabel  <span class="fa-angle-right fa"></span>Data Stock Maklon
                        </h3>
                    </div>
                  </div>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifedit');?>
                   ...
                   <!-- responsiv delete -->
                    ...
                    <div class="panel-heading">Data Stock Maklon</div>
                    <div class="panel-body">
                      ...
                      <?php
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            <td>
                              <a href="<?php echo base_url('Stock_kain/tampilDetailMaklunPerKain/'.$row->kd_subcon.''); ?>" >
                              <?php echo $row->nm_subcon; ?>
                              </a>
                            </td>
                            <td><?php echo $row->list_kain; ?></td>
                            <td><?php echo $row->list_gramasi; ?></td>
                            <td>
                              <?php echo $row->jumlah_rol; 
                               $jml_rol   = $row->jumlah_rol; 
                               $total    += $jml_rol;
                              ?> 
                            </td>
                            <td>
                              <?php echo number_format($row->jumlah_kg_grey,2); 
                               $jml_kg_grey   = $row->jumlah_kg_grey; 
                               $total_kg    += $jml_kg_grey;
                              ?> 
                            </td>
                          </tr>
                          <?php $no++;
