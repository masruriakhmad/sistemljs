    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Vendorjarum/createProses'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Data Master Vendor
                        </h3>
                    </div>
                  <div class="col-md-10">
                  <div class="col-md-12 panel">
                    <div class="col-md-12 panel-heading">
                      <h4>Tambah Data Master Vendor</h4>
                    </div>
                         ...
                         <form class="form-horizontal">                           
                              <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input class="form-control" id="nm_vendorjarum" type="text" name="nm_vendorjarum" placeholder="Diisi " required>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              <div class="form-group">
                              <div class="col-sm-4">
                                  ...
                                  <textarea class="form-control" id="alamat" type="text" name="alamat" >
                                  </textarea>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
