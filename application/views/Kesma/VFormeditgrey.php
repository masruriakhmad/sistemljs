    ...
    <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Grey/update'); ?>" id="myform" onSubmit="return validasi()"autocomplete="on" method="POST">
                      ...
                      <div class="col-md-12">
                         <form class="form-horizontal">                           
                          <div class="form-group">
                                <div class="col-sm-2">
                                  <label class="control-label">Kode Kain</label>
                                  <input class="form-control" id="kd_kain" type="text" name="kd_kain" placeholder="Diisi "value="<?php echo $edit['kd_kain']; ?>"/readOnly>
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
                              <!--
                              <div class="form-group">
                                <div class="col-md-2 col-sm-3">
                                  <label class="control-label">Nama Banang</label>
                                  <select  name="kd_customer" id="kd_customer">
                                    <option value="<?php echo $edit['kd_jenis']; ?>"><?php echo $edit['jenis_benang']; ?></option>
                                  <?php
                            ...
                            -->
                              <div class="form-group">
                                <div class="col-sm-4">
                                  ...
                                  <input class="form-control" id="nm_kain" type="text" name="nm_kain" placeholder="Diisi" value="<?php echo $edit['nm_kain']; ?>">
                                </div>
                              </div>
                              <br/><br/> <br/><br/>
