          ...
          <!-- end: Left Menu -->
            ...
            <div id="content">
              ...
              <div class="col-md-12" style="margin-top:5px;">
                ...
                <div class="col-md-1">
                <form action="<?php echo base_url('Stock_akhir_benang/export'); ?>" id="export_form" onSubmit="return validasi()"autocomplete="on" method="POST">
                  <input align="center" type="submit" id="import" name="import" value="Export Excel" class="btn btn-success" />
                </form>
              </div>
               <div class="col-md-4">
                <form action="<?php echo base_url('Stock_akhir_benang/importStockAwal'); ?>" id="import_form" onSubmit="return validasi()"autocomplete="on" method="POST">
                  <div class="col-md-4">
...
$(document).ready(function(){ 
  ...
  $('#import_form').on('submit', function(event){
    ...
    $.ajax({
      ...
      url:"<?php echo base_url() ?>Stock_akhir_benang/importStockAwal",
