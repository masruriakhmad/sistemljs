...
<head>
  ...
  <title>Form Edit Password</title>
            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                    <form action="<?php echo base_url('Pengaturan/updatePassword/'.$edit['kd_user'].'') ?>" autocomplete="on" method="POST">
                        <h3 class="animated fadeInLeft">
                          Form <span class="fa-angle-right fa"></span> Form Data Admin
                        </h3>
                    </div>
                        ...
                        <form class="cmxform" id="signupForm" method="get" action="">
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="validate_username" name="username" value="<?php echo $edit['username']; ?>"required>
                              <span class="bar"></span>
                              <label>Username</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="validate_nama" name="nm_user" value="<?php echo $edit['nm_user']; ?>" required>
                              <span class="bar"></span>
                              <label>Nama</label>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                             ...
                             <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="password" class="form-text" id="validate_password" name="password" value="<?php echo $edit['password']; ?>" required>
                              <span class="bar"></span>
                              <label>Password Lama</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="password" class="form-text" id="validate_password" name="pwbaru" required>
                              <span class="bar"></span>
                              <label>Password Baru</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="password" class="form-text" id="validate_confirm_password" name="kpwbaru" required>
                              <span class="bar"></span>
