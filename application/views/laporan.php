                    ...
                    <div class="panel-body">
                      ...
                      <thead style = "background-color :  #d6eaf8">
                        <tr>
                          ...
                          <th class="col-sm-2">No.Tr.Maklon</th>
                     ...
                     <!-- <th class="col-md-2">Kode User</th> -->
                      ...
                      <?php
                        ...
                        if($result->num_rows()>0)
                        {
                          ...
                          ?>
                           <tr>
                            <td><a hreff=""><?php echo $row->no_tr_maklun; ?></a></td>
                          ...
                          -->
                            <a href="<?php echo base_url('Pengiriman_grey/batalProses/'.$row->no_tr_maklun.''); ?>" data-confirm="Batalkan Pnenerimaan ini?" data-toogle="tooltip" title="Hapus transaksi">
