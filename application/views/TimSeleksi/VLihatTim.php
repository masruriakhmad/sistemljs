                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Table <span class="fa-angle-right fa"></span> Data Tim
                        </h3>
                    </div>
                  </div>
              </div>
              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                   ...
                   <!-- responsiv delete -->
                    <div class="panel-heading"><h3>Data Tim Peserta PMW <?php echo $tahun;?></h3></div>
                    <div class="panel-body">
                      ...
                      <thead style = "background-color :  #d6eaf8">
                        <tr>
                          <th>No</th>
                          <th>No. Tim</th>
                          <th class="col-md-6">Judul Proposal</th>
                          <th>Jenis usaha</th>
                          <th>Usulan</th>
                          <th>Aksi</th>
                        </tr>
                      ...
                      <?php
                        ...
                        if($tim->num_rows()>0)
                        {
                          ...
                          <tr class="tbl_view" id="<?php echo $row->id_tim ?>">
                            <td><?php echo $no ;?></td>
                            <td><?php echo $row->no_tim; ?></td>
                            <td><?php echo $row->judul_proposal; ?></td>
                            <td><?php echo $row->jenis_usaha; ?></td>
                            <td><?php echo "Rp. $row->usulan"; ?></td>
                            <td>
                            <a href="<?php echo base_url('AnggotaTim/lihatAnggotaTim/'.$row->id_tim.''); ?>">
