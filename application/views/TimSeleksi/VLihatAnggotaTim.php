                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                          Table <span class="fa-angle-right fa"></span> Data Anggota Tim
                        </h3>
                    </div>
                  </div>
              </div>
              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  ...
                  <?php echo $this->session->flashdata('notifhapus');?>
                    ...
                    <div class="panel-heading"><h3>Data Anggota Tim</h3></div>
                    <div class="panel-body">
