                    ...
                    <div class="col-md-12">
                        <h3 class="animated fadeInDown">
                           <div class="box-body no-padding">
                              ...
                              <h3 class="box-title" style = "color : <?php echo $this->session->userdata("color");?>"> <i class = "fa fa-user"></i> &nbsp; Pilih Data Nilai</h3>
                          </div>
                        </h3>
                    </div>
                  </div>
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <?php } ?>
                    <form class="form-horizontal" action = "<?php echo site_url("Nilai/indexNilai")?>" method = "GET">
              <div class="box-body">
