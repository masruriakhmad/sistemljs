...
class Labels {
	...
	var $format				= "html"; // word, pdf or html
	var $labels_across		= 1; // number of labels horizontally across the page
	var $labels_down		= 250; // number of labels vertically down the page
	var $label_height		= 5; // the height, in centimeters, of each label
	var $label_width		= 8; // the width, in centimeters, of each label
	var $pitch_horizontal	= 0.25; // the width of the label plus horizontal spacing, in centimeters, of each label
	var $pitch_vertical		= 0.25; // the width of the label plus vertical spacing, in centimeters, of each label
	var $page_margin_top	= 0; // the top page margin, in centimeters
	var $page_margin_side	= 0; // the left/right page margin, in centimeters
	var $page_height 		= 5; // the height of the paper. defaults to A4 dimensions
	var $page_width 		= 8; // the width of the paper. defaults to A4 dimensions
	var $align_horizontal 	= "center"; // the horizontal justification of each label. left, center or right
	var $align_vertical 	= "center"; // the vertical alignment of each label. top, center or bottom
	var $padding_left		= 0; // the left padding, in centimeters, of each label
	var $padding_top		= 0; // the top padding, in centimeters, of each label
	var $font_face			= "Arial"; // The font face to use
	var $font_size			= 10; // The font size, in pt, to use
	...
	function output($addresses=array())
	{
		...
		if (count($this->addresses)) {
			switch ($this->format) {
				...
				case "pdf":  {$output = $this->generate_labels_pdf();  break; }
