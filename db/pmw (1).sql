...
--
-- Host: 127.0.0.1
-- Generation Time: 08 Nov 2017 pada 03.48
...
(2, 'rtgffffffff', '3333333', 'Ketua', '66666', 'Fakultas Kesehatan Masyarakat');
...
--
ALTER TABLE `data_nilai`
  MODIFY `id_nilai` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=610;
--
-- AUTO_INCREMENT for table `data_tim`
--
ALTER TABLE `data_tim`
  MODIFY `id_tim` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;
